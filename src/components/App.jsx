...
export default function App() {
  ...
  const CargoCalcLogo = () => (
    <svg viewBox="0 0 64 64" className="w-48 h-48 mr-3">
      <defs>
          ...
          <div className="flex items-center justify-center">
            ...
            <div>
              ...
              <h1 className="text-gray-600">
                Nakliyeciler için Hakediş ve Vergi Hesaplama Aracı
              </h1>
              <p className="text-sm text-gray-500">
                KDV indirimi, net kazanç ve sabit masraflar dahil tüm
                hesaplamaları akıllı şekilde yapın.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-50 border-t border-gray-200 py-6 mt-12">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="text-sm text-yellow-700 space-y-2">
                  <p>
                    <strong>
                      Bu hesaplama aracı sadece genel bilgi ve fikir vermek
                      amacıyla hazırlanmıştır.
                    </strong>
                    Hesaplamalar %100 kesin değildir ve resmi vergi beyannamesi
                    veya muhasebe işlemleri için kullanılmamalıdır.
                  </p>
                  <p>
                    • Gerçek vergi hesaplamaları için{" "}
                    <strong>muhasebeci</strong> veya{" "}
                    <strong>mali müşaviriniz</strong> ile görüşüniz.
                  </p>
                  <p>
                    • Vergi oranları ve mevzuat değişiklikleri hesaplamaları
                    etkileyebilir.
                  </p>
                  <p>
                    • Bu araçtan kaynaklanan herhangi bir mali kayıp veya yanlış
                    hesaplamadan CargoCalc sorumlu değildir.
                  </p>
                  <p className="font-medium">
                    <strong>Tavsiye:</strong> Bu sonuçları muhasebe uzmanınıza
                    danışarak doğrulatın.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="text-center mt-6 pt-4 border-t border-gray-200">
            <p className="text-sm text-gray-500">
              © 2025 CargoCalc. Bu araç bilgilendirme amaçlıdır. Profesyonel
              mali danışmanlık yerine geçmez.
            </p>
          </div>
        </div>
      </footer>
